  ...
  "dictionary":{
    ...
    "bigdec":{
      ...
      "value":"3.141592653589793238462643383"
        ...
        String json = GroovyJsonWriter.objectToJson(nice, [(GroovyJsonWriter.PRETTY_PRINT):'true'])
        assertEquals(target, json)

        String json1 = GroovyJsonWriter.objectToJson(nice)
        assertNotEquals(json, json1)

        String json2 = GroovyJsonWriter.formatJson(json1)
