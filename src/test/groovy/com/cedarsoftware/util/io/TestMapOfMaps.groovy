...
class TestMapOfMaps
{
    ...
    void testForwardRefNegId() throws Exception
    {
        ...
        String json = GroovyJsonWriter.objectToJson(doc) // Neat trick json-io does - rewrites proper json from Map of Maps input
        Map doc2 = GroovyJsonReader.jsonToMaps(json)      // Read in this map of maps to JSON string and make sure it's right
    ...
    void testRhsPrimitiveTypesAreCoercedWhenTypeIsPresent()
    {
        ...
        JsonObject map = GroovyJsonReader.jsonToMaps(json)
    ...
    void testMapOfMapsSimpleArray() throws Exception
    {
        ...
        Map map = GroovyJsonReader.jsonToMaps(s)
 ...
 {"witnesses":[{"@ref":1},{"@ref":2}]}
    ...
    {
        JsonObject map = (JsonObject) GroovyJsonReader.jsonToMaps('{"num":0,"nullValue":null,"string":"yo"}')
        assertTrue(map != null)
