...
//        String j = gson.toJson(obj)
    ...
    void testReconstituteArray()
    {
        ...
        TestUtil.printLine("json0=" + json0)
        Map testArray2 = GroovyJsonReader.jsonToMaps(json0)
    ...
    void testReconstituteEmptyObject()
    {
        ...
        Map m = GroovyJsonReader.jsonToMaps(json0)
    ...
    void testAlwaysShowType()
    {
        ManyArrays ta = new ManyArrays()
        ta.init()
        def json0 = GroovyJsonWriter.objectToJson(ta, [(GroovyJsonWriter.TYPE): true])
        ManyArrays thatTa = (ManyArrays) TestUtil.readJsonObject(json0)
        assertTrue(DeepEquals.deepEquals(ta, thatTa))
        def json1 = GroovyJsonWriter.objectToJson(ta)
        TestUtil.printLine("json0 = " + json0)
        TestUtil.printLine("json1 = " + json1)
    ...
    void testCharArray()
    {
        ...
        String json0 = GroovyJsonWriter.objectToJson(cat, [(GroovyJsonWriter.TYPE):true])
        ...
        String json1 = GroovyJsonWriter.objectToJson(cat)
