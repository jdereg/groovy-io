...
class TestUnknownObjectType
{
    ...
    void testUnknownObjects()
    {
        ...
        def myParams = GroovyJsonReader.jsonToMaps(json)
        def inputParams = new GroovyJsonReader().jsonObjectsToGroovy(myParams)
        def json2 = GroovyJsonWriter.objectToJson(inputParams)
