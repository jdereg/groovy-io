...
class TestFields
{
    ...
    void testAlwaysShowType()
    {
        ...
        tf.init()
        def json0 = GroovyJsonWriter.objectToJson(tf, [(GroovyJsonWriter.TYPE):true])
        def json1 = GroovyJsonWriter.objectToJson(tf)
    ...
    void testReconstituteFields() throws Exception
    {
        ...
        Map testFields2 = GroovyJsonReader.jsonToMaps(json0)
    ...
    void testExternalFieldSpecifiedBadName() throws Exception
    {
        ...
        args.put(GroovyJsonWriter.FIELD_SPECIFIERS, fieldSpecifiers)
        try
        {
            GroovyJsonWriter.objectToJson(painful, args)
    ...
    void testExternalFieldSpecifier() throws Exception
    {
        ...
        Map args = new HashMap()
        args.put(GroovyJsonWriter.FIELD_SPECIFIERS, fieldSpecifiers)
        String json = GroovyJsonWriter.objectToJson(painful, args)
        Map check = GroovyJsonReader.jsonToMaps(json)
    ...
    void testExternalFieldSpecifierInheritance() throws Exception
    {
        ...
        def args = [(GroovyJsonWriter.FIELD_SPECIFIERS):fieldSpecifiers]
        String json = GroovyJsonWriter.objectToJson(painful, args)
        Map check = GroovyJsonReader.jsonToMaps(json)
        assertTrue(check.size() == 1)
        assertTrue(check.containsKey("name"))
        ...
        json = GroovyJsonWriter.objectToJson(painful, args)
        check = GroovyJsonReader.jsonToMaps(json)
