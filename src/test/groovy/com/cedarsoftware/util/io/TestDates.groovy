...
class TestDates
{
    ...
    void testAssignDateFromEmptyString()
    {
        ...
        Map jObj = GroovyJsonReader.jsonToMaps(json)
        ...
        jObj = GroovyJsonReader.jsonToMaps(json)
    ...
    void testCustomDateFormat()
    {
        ...
        args.put(GroovyJsonWriter.DATE_FORMAT, GroovyJsonWriter.ISO_DATE_FORMAT)
        String json = GroovyJsonWriter.objectToJson(dt, args)
        TestUtil.printLine('json = ' + json)
        ...
        args = new HashMap()
        args.put(GroovyJsonWriter.DATE_FORMAT, GroovyJsonWriter.ISO_DATE_TIME_FORMAT)
        json = GroovyJsonWriter.objectToJson(dt, args)
        TestUtil.printLine('json = ' + json)
        ...
        args.clear()
        args.put(GroovyJsonWriter.DATE_FORMAT, "yyyy-MM-dd'T'HH:mm:ss.SSS")
        json = GroovyJsonWriter.objectToJson(dt, args)
        readDt = (DateTest) TestUtil.readJsonObject(json)
        ...
        // MM/DD/YYYY format
        args.clear()
        args.put(GroovyJsonWriter.DATE_FORMAT, 'MM/dd/yyyy HH:mm:ss')
        json = GroovyJsonWriter.objectToJson(dt, args)
        readDt = (DateTest) TestUtil.readJsonObject(json)
        ...
        // Nov 15, 2013 format
        args.clear()
        args.put(GroovyJsonWriter.DATE_FORMAT, 'MMM dd, yyyy HH:mm.ss')
        json = GroovyJsonWriter.objectToJson(dt, args)
        TestUtil.printLine("json = " + json)
        readDt = (DateTest) TestUtil.readJsonObject(json)
        ...
        // 15 Nov 2013 format
        args.clear()
        args.put(GroovyJsonWriter.DATE_FORMAT, 'dd MMM yyyy HH:mm.ss')
        json = GroovyJsonWriter.objectToJson(dt, args)
        TestUtil.printLine('json = ' + json)
        readDt = (DateTest) TestUtil.readJsonObject(json)
